...
def test_brie_item_update_reduces_sell_in_by_1():
    test_brie_item = BrieItem("test_item", 5, 5)
    test_brie_item.update()
    assert test_brie_item.get_sell_in() == 4
...
def test_backstage_item_update_reduces_sell_in_by_1():
    test_backstage_pass_item = BackstagePassItem("test_item", 5, 5)
    test_backstage_pass_item.update()
    assert test_backstage_pass_item.get_sell_in() == 4
